...
#define IMX477_DEFAULT_LINK_FREQ    676000000
// #define IMX477_DEFAULT_LINK_FREQ    750000000
...
// #define IMX477_PIXEL_RATE (IMX477_DEFAULT_LINK_FREQ * 2 * 2 / (preview_mode == 0 ? 12 : 10))
...
/**
 * .hts_def = 0x3840, // 14400 | 0x41EB, // 16875 | 0x5dc0, // 24000
 * .hts_def = 0x20D0, // 8400 | 0x31c4, // 12740
 * .hts_def = 0x1EDC, // 7900 | 0x31c4, // 12740,
 * +---------------------------+--------+---------+---------+---------+-+---------+---------+---------+-+---------+---------+---------+
 * +           NAME            |   REG  |------------ 10fps ----------+ +------------ 15fps ----------+ +------------ 17fps ----------+
 * |                           |        |4056x3040|2028x1520|2028x1080| |4056x3040|2028x1520|2028x1080| |4056x3040|2028x1520|2028x1080|
 * +---------------------------+--------+---------+---------+---------+ +---------+---------+---------+ +---------+---------+---------+
 * | REG_FRAME_LEN_MSB*        | 0x0340 |  0x0d   |  0x06   |  0x05   | |  0x0c   |  0x06   |  0x05   | |  0x0c   |  0x06   |  0x05   |
 * | REG_FRAME_LEN_LSB*        | 0x0341 |  0xac   |  0x70   |  0x26   | |  0x1e   |  0x70   |  0x26   | |  0x1e   |  0x70   |  0x26   |
 * | REG_LINE_LEN_MSB*         | 0x0342 |  0x5d   |  0x31   |  0x31   | |  0x38   |  0x20   |  0x1e   | |  0x38   |  0x20   |  0x1e   |
 * | REG_LINE_LEN_LSB*         | 0x0343 |  0xc0   |  0xc4   |  0xc4   | |  0x40   |  0xd0   |  0xdc   | |  0x40   |  0xd0   |  0xdc   |
 * | REG_DIG_CROP_X_OFFSET_MSB | 0x0408 |  0x00   |  0x00   |  0x00   | |  0x00   |  0x00   |  0x00   | |  0x00   |  0x00   |  0x00   |
 * | REG_DIG_CROP_X_OFFSET_LSB | 0x0409 |  0x00   |  0x00   |  0x00   | |  0x00   |  0x00   |  0x00   | |  0x00   |  0x00   |  0x00   |
 * | REG_DIG_CROP_Y_OFFSET_MSB | 0x040A |  0x00   |  0x00   |  0x00   | |  0x00   |  0x00   |  0x00   | |  0x00   |  0x00   |  0x00   |
 * | REG_DIG_CROP_Y_OFFSET_LSB | 0x040B |  0x00   |  0x00   |  0x00   | |  0x00   |  0x00   |  0x00   | |  0x00   |  0x00   |  0x00   |
 * | REG_DIG_CROP_WIDTH_MSB    | 0x040C |  0x0f   |  0x0f   |  0x0f   | |  0x0f   |  0x0f   |  0x0f   | |  0x0f   |  0x0f   |  0x0f   |
 * | REG_DIG_CROP_WIDTH_LSB    | 0x040D |  0xd8   |  0xd8   |  0xd8   | |  0xd8   |  0xd8   |  0xd8   | |  0xd8   |  0xd8   |  0xd8   |
 * | REG_DIG_CROP_HEIGHT_MSB   | 0x040E |  0x0b   |  0x0b   |  0x04   | |  0x0b   |  0x0b   |  0x04   | |  0x0b   |  0x0b   |  0x04   |
 * | REG_DIG_CROP_HEIGHT_LSB   | 0x040F |  0xe0   |  0xe0   |  0x38   | |  0xe0   |  0xe0   |  0x38   | |  0xe0   |  0xe0   |  0x38   |
 * +---------------------------+--------+---------+---------+---------+ +---------+---------+---------+ +---------+---------+---------+
 * | REG_EXCK_FREQ             | 0x0136 |                            0x18                                                             |
 * | REG_IOP_PREPLLCK_DIV(+)   | 0x030d |            0x02             | |            0x03             | |            0x03             |
 * | REG_IOP_MPY_MSB(+)        | 0x030e |            0x00             | |            0x01             | |            0x01             |
 * | REG_IOP_MPY_LSB(+)        | 0x030f |            0x96             | |            0x52             | |            0x77             |
 * | REG_IVTPXCK_DIV           | 0x0301 |            0x05             | |            0x05             | |            0x05             |
 * | REG_IVTSYCK_DIV           | 0x0303 |            0x02             | |            0x02             | |            0x02             |
 * | REG_IVT_PREPLLCK_DIV      | 0x0305 |            0x04             | |            0x04             | |            0x04             |
 * | REG_PLL_IVT_MPY_MSB       | 0x0306 |            0x01             | |            0x01             | |            0x01             |
 * | REG_PLL_IVT_MPY_LSB       | 0x0307 |            0x5e             | |            0x5e             | |            0x5e             |
 * | REG_IOPPXCK_DIV           | 0x0309 |                            0x0c                                                             |
 * | REG_IOPSYCK_DIV           | 0x030B |                            0x02                                                             |
 * +---------------------------+--------+---------+---------+---------+-+---------+---------+---------+-+---------+---------+---------+
 * IOPPXCK = EXCK / REG_IOP_PREPLLCK_DIV x REG_PLL_IOP_MPY / (REG_IOPPXCK_DIV x REG_IOPSYCK_DIV)
 *
 * IOPCK = EXCK / REG_IOP_PREPLLCK_DIV x REG_PLL_IOP_MPY
 * IMX477_DEFAULT_LINK_FREQ = IOPCK / 4 * 1.000.000
 *                          = 0x18(24) / 0x02 * 0x0096(150) / 4 * 1.000.000 = 450.000.000
 *                          = 0x18(24) / 0x03 * 0x0140(320) / 4 * 1.000.000 = 640.000.000
 *                          = 0x18(24) / 0x03 * 0x0152(338) / 4 * 1.000.000 = 676.000.000
 *                          = 0x18(24) / 0x03 * 0x0177(375) / 4 * 1.000.000 = 750.000.000
 *
 * IVTPXCK = EXCK / REG_IVT_PREPLLCK_DIV x REG_PLL_IVT_MPY / (REG_IVTPXCK_DIV x REG_IVTSYCK_DIV)
 * IMX477_PIXEL_RATE = IVTPXCK x 4 x 1.000.000
 *                   = 0x18(24) / 0x04 * 0x015e(350) / (5*2) * 4 * 1.000.000 = 840.000.000
 *                   = 0x18(24) / 0x04 * 0x019a(410) / (5*2) * 4 * 1.000.000 = 984.000.000
 * [*] Set when change resolution
 * [+] Change fps
 */
/* 12 mpix 10fps */
// .hts_def = 0x5dc0, // 24000 ~ 10fps
// .hts_def = 0x3e80, // 16000 ~ 15fps
...
static const struct imx477_mode supported_modes_12bit[] = {
    {
        ...
        // .hts_def = 0x5dc0, // 24000 ~ 10fps
        .hts_def = 0x3e80, // 16000 ~ 15fps
        // .hts_def = 0x2ee0, // 12000 ~ 20fps        
        // .hts_def = 0x5dc0, // 24000 || 0x2ee0, // 12000 | 0x3840, // 14400 | 0x41EB, // 16875
        .vts_def = 0x0dac, // 3500
        .crop = {
            .left = 0,
            .top = 0,
    ...
    },
    {
        ...
        .width = 2028,
        .height = 1520,
        .hts_def = 0x31c4, // 12740 | 0x20D0, // 8400
        .vts_def = 0x0670, // 1648
        .crop = {
            .left = 0,
            .top = 0,
    ...
    },
    {
        ...
        .width = 2028,
        .height = 1080,
        .hts_def = 0x31c4, // 12740, 0x1EDC, // 7900
        .vts_def = 0x0526, // 1318
        .crop = {
...
static const struct imx477_mode supported_modes_10bit[] = {
    {
        /* 1332x990 120fps. 2x2 binned and cropped */
        .width = 1332,
        .height = 990,
        .hts_def = 6664,
        .vts_def = 1050,
                       ...
                       struct v4l2_subdev_frame_interval_enum *fie)
{
    ...
    dev_info(&client->dev, "imx477_enum_frame_interval %d %dx%d, %d/%d\n", 
        fie->index, fie->width, fie->height, fie->interval.numerator, fie->interval.denominator);
    return 0;
}
...
static void imx477_set_framing_limits(struct imx477 *imx477)
{
    ...
    __v4l2_ctrl_s_ctrl(imx477->hblank, hblank);
}
                    ...
                    struct v4l2_subdev *sd, struct v4l2_subdev_format *fmt)
{
    ...
    dev_info(&client->dev, "imx477_find_best_fit num_modes %d, size %dx%d\n", num_modes, framefmt->width, framefmt->height);
                 ...
                 struct v4l2_subdev_format *fmt)
{
    ...
    dev_info(&client->dev, "imx477_set_pad_format %d,%d -> %d,%d\n", fmt->format.width, fmt->format.height, mode->width, mode->height);
...
static long imx477_ioctl(struct v4l2_subdev *sd, unsigned int cmd, void *arg)
{
    ...
    struct i2c_client *client = v4l2_get_subdevdata(&imx477->sd);
    long ret = 0;
    dev_info(&client->dev, "imx477_ioctl %d\n", cmd);
                  ...
                  unsigned int cmd, unsigned long arg)
{
    ...
    long ret;
    dev_info(&client->dev, "imx477_compat_ioctl32 %x - %x,%x\n", cmd, 
    ...
    struct v4l2_subdev_frame_size_enum *fse)
{
    ...
    if (fse->index >= ARRAY_SIZE(supported_modes_12bit))
        return -EINVAL;

    if (fse->code != MEDIA_BUS_FMT_SRGGB12_1X12)
        return -EINVAL;

    const struct imx477_mode* mode = &supported_modes_12bit[fse->index];
    fse->min_width  = mode->width;
    fse->max_width  = mode->width;
    fse->max_height = mode->height;
    fse->min_height = mode->height;

    dev_info(&client->dev, "imx477_enum_frame_sizes %d, %d, %dx%d\n",
            ...
            const struct i2c_device_id *did)
{
    ...
    //imx477->enable_gpio = enable_gpio;
    imx477->module_index = 0;
    imx477->module_facing = "back";
    imx477->module_name = "RPi_HQ";
    imx477->len_name = "default";

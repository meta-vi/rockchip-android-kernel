	...
	struct v4l2_subdev_frame_size_enum *fse)
{
	...
	fse->min_width  = supported_modes_12bit[fse->index].width;
	fse->max_width  = supported_modes_12bit[fse->index].width;
	fse->max_height = supported_modes_12bit[fse->index].height;
	fse->min_height = supported_modes_12bit[fse->index].height;
